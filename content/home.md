<!--
   ...
   The first heading (#) is the page title, and the paragraph under it
   is the large introductory sentence. Each "##" starts a new section;
   the words before "::" are the small grey label above the heading.

   A line starting with ">" becomes an indented note.
...
[All events and past programme →](events.html)
